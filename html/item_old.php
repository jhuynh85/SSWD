    ...
    <div class="row">
        <?php foreach ($products as $product) :
            ...
            <div class="col-xs-5" style="border:0px solid #eee">
                ...
                <div class="section">
                    <a href="cart.php">
                    <div id="addBtn" class="btn btn-primary btn-lg"><span style="margin-right:20px"
                                                                          class="glyphicon glyphicon-shopping-cart"
                                                                          aria-hidden="true"></span> Add to Cart
                    </div>
                    </a>
                    <h6><a href="#"><span class="glyphicon glyphicon-heart-empty" style="cursor:pointer;"></span> Write
                            a review</a></h6>
                </div>
            </div>
            <div class="col-xs-10">
