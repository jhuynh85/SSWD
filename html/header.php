...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand animated shake" href="products.php"><img src="images/VF2.png" alt="VF logo"
                                                                        width="30"></a></div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <div id="logcart"> <?php echo $logged_in; ?><a href="cart.php"><img src="images/cart2.png" alt=""
                                                                            title="Shopping Cart"/></a></div>
    </div>
</nav>
