...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="list-group"><a href="products.php" class="list-group-item">Category 1: &nbsp;&nbspT-shirts </a>
                <a href="products2.php" class="list-group-item">Category 2: &nbsp;&nbsp;Hats</a> <a href="products3.php"
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail"><img src="images/JPEG/T-shirt_01.jpg" alt="" width="200">
                        <div class="caption">
                            <h4 class="pull-right">$59.99</h4>
                            <h4><a href="item.php" target="_blank">Item 1</a></h4>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail"><img src="images/JPEG/T-shirt_02.jpg" alt="" width="200">
                        <div class="caption">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail"><img src="images/JPEG/T-shirt_03.jpg" alt="" width="200">
                        <div class="caption">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail"><img src="images/JPEG/T-shirt_04.jpg" alt="" width="200">
                        <div class="caption">
                        ...
                        <div class="ratings">
                            ...
                            <p><span class="glyphicon glyphicon-heart"></span> <span
                                        ...
                                        class="glyphicon glyphicon-heart"></span> <span
                                        class="glyphicon glyphicon-heart"></span> <span
                                        class="glyphicon glyphicon-heart-empty"></span></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail"><img src="images/JPEG/T-shirt_05.jpg" alt="" width="200">
                        <div class="caption">
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail"><img src="images/JPEG/T-shirt_06.jpg" alt="" width="200">
                        <div class="caption">
