          ...
          <div class="col-md-12">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="item active"> <img class="slide-image" src="images/hp.jpg" alt=""> </div>
                <div class="item"> <img class="slide-image" src="images/horse.jpg" alt=""> </div>
                <div class="item"> <img class="slide-image" src="images/lion.jpg" alt=""> </div>
              </div>
