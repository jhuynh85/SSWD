...
<body>
  ...
  <form method="post" action=" ">
    ...
    <div id="toL">
      ...
      <div class="form-group">
        <div class="payment"><strong>Card CVV:</strong> <a href="https://www.cvvnumber.com/cvv.html" target="_blank" style="font-size:11px">What is my CVV code?</a> </div>
        <div>
  ...
  <div id="toR">
    ...
    <div> <a href="https://www.paypal.com/signin?country.x=US&locale.x=en_US" target="_blank"><img src="https://www.paypal.com/en_US/i/btn/btn_xpressCheckout.gif" alt=""></a> </div>
  </div>
